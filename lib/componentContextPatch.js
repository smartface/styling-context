...
function componentContextPatch(component, name) {
    component.themeContext = Application.theme((0, pageContext_1.default)(component, name, null, null), name);
    component.onShow = (0, patchMethod_1.default)(component, "onShow", onShow);
