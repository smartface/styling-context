...
function pageContextPatch(page, name) {
    page.onLoad = (0, patchMethod_1.default)(page, "onLoad", onLoad);
    page.onShow = (0, patchMethod_1.default)(page, "onShow", onShow);
    page.onHide = (0, patchMethod_1.default)(page, "onHide", onHide);
    page.componentDidEnter = (0, patchMethod_1.default)(page, "componentDidEnter", componentDidEnter);
    page.onOrientationChange = (0, patchMethod_1.default)(page, "onOrientationChange", onOrientationChange);
    // hides unload logic
    ...
    function onLoad(superOnLoad) {
        ...
        this.themeContext = Application.theme((0, pageContext_1.default)(page, name, null, null), name);
        updateHeaderBar.call(this);
    }
