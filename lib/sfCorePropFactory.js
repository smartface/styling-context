...
function createGifImageForDevice(gifImage) {
    return require("@smartface/native/ui/gifimage").createFromFile("assets://".concat(gifImage));
}
    ...
    return function (color) {
        ...
        if (color instanceof Object) {
            ...
            if (!HexColorValidationRegexp.test(color) ||
                ...
                throw new Error("".concat(color, " is invalid value. Please, check your styles"));
